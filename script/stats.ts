...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/SkyeGT/CastClaw/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for SkyeGT/CastClaw...\n")
...
console.log("Fetching npm all-time downloads for castclaw-ai...\n")
const npmDownloads = await fetchNpmDownloads("castclaw-ai")
