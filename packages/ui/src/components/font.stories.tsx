...
const docs = `### Overview
Loads CastClaw typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>CastClaw Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>CastClaw Mono Sample</div>
    </div>
  ),
}
