...
/**
 * Server configuration for castclaw serve and web commands
 */
export type ServerConfig = {
  ...
  mdns?: boolean
  /**
   * Custom domain name for mDNS service (default: castclaw.local)
   */
  mdnsDomain?: string
  /**
...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://github.com/SkyeGT/CastClaw/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://github.com/SkyeGT/CastClaw/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
