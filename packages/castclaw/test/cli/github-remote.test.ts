...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/castclaw.git")).toEqual({ owner: "sst", repo: "castclaw" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/castclaw")).toEqual({ owner: "sst", repo: "castclaw" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/castclaw.git")).toEqual({ owner: "sst", repo: "castclaw" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/castclaw")).toEqual({ owner: "sst", repo: "castclaw" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/castclaw.git")).toEqual({ owner: "sst", repo: "castclaw" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/castclaw")).toEqual({ owner: "sst", repo: "castclaw" })
})
