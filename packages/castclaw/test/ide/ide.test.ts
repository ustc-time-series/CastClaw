...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CASTCLAW_CALLER", () => {
    process.env["CASTCLAW_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CASTCLAW_CALLER", () => {
    process.env["CASTCLAW_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CASTCLAW_CALLER", () => {
    process.env["CASTCLAW_CALLER"] = "unknown"
