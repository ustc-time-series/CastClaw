  ...
  describe("latest", () => {
    ...
    test("reads brew formulae API versions", async () => {
      const layer = testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("anomalyco/tap/castclaw")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("castclaw")) return "castclaw"
          return ""
        },
      )
    ...
    test("reads brew tap info JSON via CLI", async () => {
      ...
      const layer = testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("anomalyco/tap/castclaw") && args.includes("--formula")) return "castclaw"
