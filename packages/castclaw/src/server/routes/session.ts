  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all CastClaw sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific CastClaw session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new CastClaw session for interacting with AI assistants and managing conversations.",
