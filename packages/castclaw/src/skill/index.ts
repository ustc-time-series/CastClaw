...
export namespace Skill {
  ...
  const CASTCLAW_SKILL_PATTERN = "{skill,skills}/**/SKILL.md"
  ...
  async function loadSkills(state: State, discovery: Discovery.Interface, directory: string, worktree: string) {
    if (!Flag.CASTCLAW_DISABLE_EXTERNAL_SKILLS) {
    ...
    for (const dir of await Config.directories()) {
      await scan(state, dir, CASTCLAW_SKILL_PATTERN)
    }
  ...
  export class Service extends ServiceMap.Service<Service, Interface>()("@castclaw/Skill") {}
