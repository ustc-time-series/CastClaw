export const dict = {
  ...
  "dialog.provider.castclaw.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.castclaw.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.castclawGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CastClaw",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i CastClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i CastClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i CastClaw.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i castclaw.json",
  ...
  "dialog.server.description": "Skift hvilken CastClaw-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af CastClaw ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CastClaw-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (castclaw.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CastClaw understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CastClaw inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CastClaw-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CastClaw",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan CastClaw ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om CastClaw følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan CastClaw er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CastClaw starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CastClaw.",
