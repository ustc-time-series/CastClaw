...
export const dict = {
  ...
  "dialog.provider.castclaw.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.castclaw.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.castclawGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CastClaw",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i CastClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CastClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CastClaw.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i castclaw.json",
  ...
  "dialog.server.description": "Bytt hvilken CastClaw-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CastClaw ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CastClaw-teamet",
  "error.page.report.github-issues": "på GitHub Issues",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (castclaw.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CastClaw ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CastClaw inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CastClaw-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CastClaw",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CastClaw ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om CastClaw skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan CastClaw er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CastClaw starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CastClaw.",
