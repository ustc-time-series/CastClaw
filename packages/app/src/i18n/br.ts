export const dict = {
  ...
  "dialog.provider.castclaw.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.castclaw.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.castclawGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CastClaw",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CastClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CastClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CastClaw.",
  ...
  "dialog.plugins.empty": "Plugins configurados em castclaw.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CastClaw este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do CastClaw ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CastClaw",
  "error.page.report.github-issues": "no GitHub Issues",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (castclaw.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CastClaw ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CastClaw inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CastClaw dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CastClaw",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o CastClaw aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CastClaw segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CastClaw é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CastClaw iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CastClaw.",
