export const dict = {
  ...
  "dialog.provider.castclaw.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.castclaw.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.castclawGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CastClaw",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CastClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CastClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CastClaw.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w castclaw.json",
  ...
  "dialog.server.description": "Przełącz serwer CastClaw, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja CastClaw ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CastClaw",
  "error.page.report.github-issues": "na GitHub Issueszie",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (castclaw.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "CastClaw zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CastClaw",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd CastClaw na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CastClaw ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CastClaw.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CastClaw",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CastClaw.",
