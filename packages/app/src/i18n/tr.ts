...
export const dict = {
  ...
  "dialog.provider.castclaw.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.castclaw.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.castclawGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "CastClaw tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CastClaw'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve CastClaw'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CastClaw'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler castclaw.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CastClaw sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "CastClaw'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CastClaw ekibine bildirin",
  "error.page.report.github-issues": "GitHub Issues üzerinden",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (castclaw.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: CastClaw henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CastClaw ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CastClaw Masaüstü",
  ...
  "settings.desktop.wsl.description": "CastClaw sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CastClaw'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "CastClaw'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CastClaw'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CastClaw'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CastClaw başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CastClaw'un en son sürümünü kullanıyorsunuz.",
