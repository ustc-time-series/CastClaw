export const dict = {
  ...
  "dialog.provider.castclaw.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.castclaw.tagline": "Modelos optimizados y fiables",
  "dialog.provider.castclawGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CastClaw",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CastClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CastClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CastClaw.",
  ...
  "dialog.plugins.empty": "Plugins configurados en castclaw.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de CastClaw se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de CastClaw ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de CastClaw",
  "error.page.report.github-issues": "en GitHub Issues",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (castclaw.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, CastClaw no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "CastClaw incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "app.name.desktop": "CastClaw Desktop",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CastClaw dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CastClaw",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve CastClaw en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CastClaw sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CastClaw.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CastClaw",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CastClaw.",
