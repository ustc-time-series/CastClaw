export const dict = {
  ...
  "dialog.provider.castclaw.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.castclaw.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.castclawGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CastClaw",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CastClaw-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CastClaw-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CastClaw-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u castclaw.json",
  ...
  "dialog.server.description": "Promijeni na koji se CastClaw server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija CastClaw-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CastClaw timu",
  "error.page.report.github-issues": "na GitHub Issuesu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (castclaw.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CastClaw još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CastClaw uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CastClaw server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CastClaw-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako CastClaw izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CastClaw prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CastClaw-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CastClaw pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CastClaw-a.",
