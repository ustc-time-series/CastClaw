export const dict = {
  ...
  "dialog.provider.castclaw.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.castclaw.tagline": "Reliable optimized models",
  "dialog.provider.castclawGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CastClaw",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CastClaw.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CastClaw.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CastClaw.",
  ...
  "dialog.plugins.empty": "Plugins configured in castclaw.json",
  ...
  "dialog.server.description": "Switch which CastClaw server this app connects to.",
  ...
  "toast.update.description": "A new version of CastClaw ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CastClaw team",
  "error.page.report.github-issues": "on GitHub Issues",
  ...
  "error.chain.checkConfig": "Check your config (castclaw.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CastClaw does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CastClaw includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the CastClaw server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CastClaw",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CastClaw looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CastClaw follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CastClaw is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CastClaw launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CastClaw.",
