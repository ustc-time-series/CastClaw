...
import { Select } from "@castclaw/ui/select"
import { Switch } from "@castclaw/ui/switch"
...
let font: Promise<typeof import("@castclaw/ui/font-loader")> | undefined

function loadFont() {
  font ??= import("@castclaw/ui/font-loader")
  return font
}
        ...
        <SettingsRow
          ...
          description={
            <>
              ...
              <Link href="https://github.com/SkyeGT/CastClaw/themes/">{language.t("common.learnMore")}</Link>
            </>
          }
        >
          <Select
