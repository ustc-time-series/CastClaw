...
beforeAll(async () => {
  ...
  mock.module("@castclaw/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@castclaw/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@castclaw/ui/icon", () => ({ Icon: () => null }))
  mock.module("@castclaw/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
