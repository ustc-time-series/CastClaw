import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@castclaw/sdk/v2/client"
...
import { List, type ListRef } from "@castclaw/ui/list"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <div class="text-14-regular text-text-base">
          {provider().id === "castclaw"
            ? "Use the API key configured for your CastClaw environment."
