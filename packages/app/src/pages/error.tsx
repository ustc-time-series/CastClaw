...
import { Logo } from "@castclaw/ui/logo"
        ...
        <div class="flex flex-col items-center gap-2">
          <div class="flex items-center justify-center gap-1">
            ...
            <button
              ...
              onClick={() => platform.openLink("https://github.com/SkyeGT/CastClaw/issues")}
            >
              <div>{language.t("error.page.report.github-issues")}</div>
