import type { Message, Session, TextPart, UserMessage } from "@castclaw/sdk/v2/client"
import { Avatar } from "@castclaw/ui/avatar"
import { HoverCard } from "@castclaw/ui/hover-card"
import { Icon } from "@castclaw/ui/icon"
import { IconButton } from "@castclaw/ui/icon-button"
import { MessageNav } from "@castclaw/ui/message-nav"
import { Spinner } from "@castclaw/ui/spinner"
import { Tooltip } from "@castclaw/ui/tooltip"
import { base64Encode } from "@castclaw/util/encode"
...
const CASTCLAW_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
  ...
  return (
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={props.project.id === CASTCLAW_PROJECT_ID ? "/favicon.svg" : props.project.icon?.override}
