...
import { ResizeHandle } from "@castclaw/ui/resize-handle"
...
import { Session, type Message } from "@castclaw/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@castclaw/ui/toast"
...
import { useTheme, type ColorScheme } from "@castclaw/ui/theme/context"
...
export default function Layout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://github.com/SkyeGT/CastClaw/issues")}
      renderPanel={() =>
